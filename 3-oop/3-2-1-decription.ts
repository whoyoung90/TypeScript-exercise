{
  ...
  /**
   * @descsription static
   * static를 선언한 변수는 클래스 내에서 this를 사용 못하며, 해당변수 앞에 클래스명.
   * static를 선언하면 new 객체를 생성하지 않아도 사용 가능하다. (없으면 new 필수)
   ...
   * static 제거시, 더이상 class level에 있는 함수를 이용할 수 없고 만들어진 object안에서 호출해야 한다. (ex. maker2.makeMachine)
